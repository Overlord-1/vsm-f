...
const Header = ({ text }) => {
  ...
  return (
    <div className='w-full mx-auto max-w-[1240px] p-7 mb-5 flex justify-between items-center bg-gradient-to-r from-[#6cff7334] to-midnight-900 shadow-lg rounded-b-3xl'>
